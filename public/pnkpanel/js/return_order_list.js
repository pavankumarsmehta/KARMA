(function($) {
	...
	dtOptions = {
		...
		createdRow: function(row, data, dataIndex) {
			var return_request_read_unread = data.return_request_read_unread; // Assuming new_field is the name of the new field
			var row_color = ''; 
			var fontweight = '';
			if (return_request_read_unread === '0') {
				row_color = '#00000';
				fontweight = 'bold';
			}
			$(row).css('color', row_color);
			$(row).css('font-weight', fontweight);
		}
	};
