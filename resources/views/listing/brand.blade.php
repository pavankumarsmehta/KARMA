...
<div class="container">
	...
	<div class="toolbar">
		...
		<div class="toolbar-results hidden-xs-down" tabindex="0">@if($TotalProducts > 0) {{$TotalProducts}} @endif Results</div>
			...
			<div class="row row-no-gutters">
				...
				{{--
					<ul class="filter-current">
						<li>Color: 
							<a href="#"  title="Black" aria-label="Black">Black 
						...
						<li><a href="#" tabindex="0" title="Clear All" aria-label="Clear All">Clear All</a></li>
					</ul>
				--}}	
				</div>             
				<div class="col-xs-12">
						...
						<li>
							<div class="product clearfix">
								<div class="product_thumb">
									<a href="{{$Product->product_url}}" rel="nofollow" title="Product">
										<picture><img src="{{$Product->prod_image}}" alt="" width="365" height="365" loading="lazy" /></picture>
									</a>
									<a href="javascript:void(0)" rel="nofollow" title="Add to wishlist" class="wishlist active-">
								...
								<div class="product_name">
									<a href="{{$Product->product_url}}" rel="nofollow" title="Lorem ipsum dolor sit amet consectetur. Sed quis urna habitant in.">{{$Product->product_name}}</a>
								</div>
								<div class="product_price">{{$Product->our_price}}</div>
								<!-- <div class="product_review"><img src="images/star.png" alt="" width="72" height="13" loading="lazy"/>(110)</div> -->
							</div>
						</li>
						@endforeach	
					</ul>
				...
				<div class="col-xs-12 pt-4">
					<a class="btn btn-block btn-loadmore" data-page="">Load More ...</a>
				</div>
				<div class="col-xs-12 pt-4">
					<div class="lst_dis">
