...
<div class="sp-inner sp-basket">
	...
	<ol class="Cart-items">
		...
		<li>
			<div class="product">
				<a href="{{$APP_URLS.$CartItem['product_url']}}" title="{{$CartItem['ProductName']}}" rel="nofollow" tabindex="0" class="product_thumb">
				...
				<?php //dd($CartItem);?>
				<div class="product_name"><a href="{{$APP_URLS.$CartItem['product_url']}}" title="{{$CartItem['ProductName']}}" rel="nofollow">{{$CartItem['ProductName']}}</a></div>
