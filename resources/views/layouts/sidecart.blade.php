	...
	<div class="sp-content <?php if(isset($CartDetails['Cart']) && count($CartDetails['Cart']) > 0){ }else{?>sp-content-empty<?php }?>" id="shopcart">
		<div class="sp-inner sp-basket">
			...
			<ol class="Cart-items">
				...
				<li>
					<div class="product">
						<a href="{{$APP_URLS.$CartItem['product_url']}}" title="{{$CartItem['ProductName']}}" aria-label="{{$CartItem['ProductName']}}" tabindex="0" class="product_thumb">
						...
						<div class="product_name"><a href="{{$APP_URLS.$CartItem['product_url']}}" title="{{$CartItem['ProductName']}}" aria-label="{{$CartItem['ProductName']}}">{{$CartItem['ProductName']}}</a></div>
