...
<div class="checkout">
	<div class="container">
		<div class="ord-receipt">
					...
					@if(count($OrderDetails) > 0)	
						@foreach($OrderDetails as $key => $val)
							<div class="loop">
								<div class="cart_row">
									<div class="thumb">
										<a href="{{$val['product_url']}}" title="Test"><img src="{{ $val['Image'] }}" alt="" width="175" height="175"></a>
									</div>
			...
			<div class="row row10">
				<div class="col-xs-12 col-sm-6 pt-5"><a href="#" class="btn f700 btn-xs-block btn-success place-ord-btn">CONTINUE SHOPPING</a></div>
