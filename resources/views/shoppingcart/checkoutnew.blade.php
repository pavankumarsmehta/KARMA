						...
						<div class="checkout-acd active" id="shipping-acd">
							...
							<div id="shipping_form_section">
								...
								<div class="pt-2">
									...
									<input type="text" class="form-control" id="bl_sh_email" name="bl_sh_email" value="{{$Shipping['email']}}" placeholder="Email *" required @auth readonly @endauth autofocus>
								...
								<div id="billing_adddress_box" style="display:none;">
									...
									<div class="row row10">
										<div class="col-xs-12 col-sm-6 pt-3">
											...
											<div class="error error-cls-billing" id="error_bl_fname"></div>
										</div>
										<div class="col-xs-12 col-sm-6 pt-3">
											...
											<div class="error error-cls-billing" id="error_bl_lname"></div>
										</div>
									</div>
									<div class="pt-3">
										...
										<div class="error error-cls-billing" id="error_bl_Addr1"></div>
									</div>
									<div class="pt-3">
									...
									<div class="row row10">
										<div class="col-xs-12 col-sm-6 pt-3">
											...
											<div class="error error-cls-billing" id="error_bl_city"></div>
										</div>
										<div class="col-xs-12 col-sm-6 pt-3">
											...
											<div class="error error-cls-billing" id="error_bl_country"></div>
										</div>
									</div>
									<div class="row row10">
										<div class="col-xs-12 col-sm-4 pt-3">
											...
											<div class="error error-cls-billing" id="error_bl_state"></div>
											<div class="error error-cls-billing" id="error_bl_otherstate"></div>
										</div>
										<div class="col-xs-12 col-sm-4 pt-3">
											...
											<div class="error error-cls-billing" id="error_bl_zip"></div>
										</div>
										<div class="col-xs-12 col-sm-4 pt-3">
											...
											<div class="input-group"> {{-- <span class="input-group-text">+1</span> --}}
												...
												<div class="error error-cls-billing" id="error_bl_phone"></div>
											</div>
											<span class="ex-label">Used for order notifications</span>
										</div>
									</div>
			...
			<div class="checkout_right">
				...
				<div class="order_summary">
					...
					<div class="yr-item">
						...
						@if($CartLength > 0)
							<div id="all-product-remove" class="dnone">
