...
<div class="container">
	...
	<section class="space70">
		<div class="cm-hd">
			...
			<div class="cm-hd-right"><a href="{{config('const.SITE_URL')}}/brand-{{title($Category_detail->category_name)}}.html" title="View all Popular Brands" class="linksbb" tabindex="0"><strong>View all <span class="hidden-xs-down">Popular Brands</span></strong></a></div>
		</div>
