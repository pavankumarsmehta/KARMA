		...
		<div class="track-order-main">
			<div class="row mb-4">
				...
				<div class="col-lg-4 col-sm-5">
					...
					<button type="button" class="btn btn-success btn-block" title="Track Order" aria-label="Track Order">Track Order</button>
				</div>
			</div>
						...
						@if($isOrderReturnable == 1)
							<td data-th="Return Request">
								...
								@elseif($order_details_value->is_return_request == 1 && $OrderReturnDate >= date('Y-m-d'))
									<p style="color:red;">Your return request for this item is sent.</p>
								@endif
						...
						<ul class="ship_method dflex dfwrap">
							<li>
								@if($OrderRs[0]->ship_method != "")
									...
									<p class="mb-0">{{$OrderRs[0]->ship_method}}</p>
								@endif
								@if($OrderRs[0]->tracking_no != "")
									<div class="h6 mb-1">Tracking</div>
									<p class="mb-0">
									@if(strtolower($OrderRs[0]->ShippingCompany) == "fedex")
									...
									@elseif(strtolower($OrderRs[0]->ShippingCompany) == "usps")
									...
									@elseif(strtolower($OrderRs[0]->ShippingCompany) == "ups")
								...
								@endif
								@if($OrderRs[0]->ShippingCompany != "")
									<div class="h6 mb-1">Shipping Company</div>
									<p class="mb-0">{{$OrderRs[0]->ShippingCompany}}</p><br>
								@endif
