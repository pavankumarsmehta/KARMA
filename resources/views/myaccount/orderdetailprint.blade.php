...
.myact_hd{border-bottom:1px solid #bdbdbd;padding:20px 0;position:relative}
.myact_hd h2{margin:0;padding:5px 0 0 0;text-transform:inherit;font-size:28px;color:#000;font-weight:600}
...
.myorder_dtl .order_info table{border:0;border-collapse:0;border-spacing:0;text-align:left;display:inline-block}
.myorder_dtl .order_info table td{font-size:13px;text-transform:uppercase;line-height:13px;color:#000;padding:5px 10px 5px 0}
.myorder_dtl .order_info table td strong{font-weight:600}
.myorder_dtl .st_table{border:0;border-collapse:0;border-spacing:0;text-align:left;/*width:100%*/width:400px;}
...
.myorder_dtl .st_table th{background-color:#ddd;font-size:20px;font-weight:600;padding:10px}
.myorder_dtl .st_table th strong{font-size:20px;font-weight:600}
.deliv_dtl{float:right;margin-right:-10px;}
...
/*@media (max-width:574px) {.myorder_dtl .deliv_dtl .yline{border-right:0;border-bottom:1px solid #ddd;padding-bottom:5px}}*/
...
#Rptable table{border:0;width:100%;border-collapse:0;border-spacing:0;color:#000;}
#Rptable table thead td, #Rptable table thead th{padding:10px;border-bottom:2px solid #000;font-size:14px;text-transform:uppercase;font-weight:600;}
#Rptable table tbody td{padding:10px;border-bottom:1px solid #e2e2e2;vertical-align:top;font-size:15px;}
...
#Rptable{margin:0 auto;width:100%;}
#Rptable table, #Rptable tbody, #Rptable tbody td, #Rptable tbody tr, #Rptable tfoot, #Rptable tfoot td, #Rptable tfoot tr, #Rptable thead, #Rptable thead th{display:block;}
#Rptable thead tr{position:absolute;top:-9999px;left:-9999px;}
#Rptable tbody tr, #Rptable thead tr{border:1px solid #ccc;}
#Rptable tbody td, #Rptable thead td{border:none;border-bottom:1px solid #eee;position:relative;padding-left:50%!important;text-align:left;}
#Rptable tbody td:before{content:attr(data-title) "";}
#Rptable tbody td:before{position:absolute;top:9px;left:10px;width:45%;text-align:left;line-height:17px;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;}
