				...
				<div class="datatables-header-footer-wrapper">
					...
					<div class="datatable-header">
						<div class="row align-items-center mb-3">
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0"> <a href="{{ route('pnkpanel.category.edit' ) }}" class="btn btn-primary btn-md"><i class="bx bx-plus"></i> Add New </a> </div>
...
let url_bulk_action = "{{ route('pnkpanel.category.bulk_action') }}";
let url_bulk_action_update_rank = "{{ route('pnkpanel.category.bulk_action_update_rank') }}";
</script>
<script src="{{ asset('pnkpanel/js/category_list.js') }}"></script>
@endpush
