...
@push('scripts')
<script>
let url_list = "{{ route('pnkpanel.newsletter.list') }}";
let url_bulk_action = "{{ route('pnkpanel.newsletter.bulk_action') }}";
</script>
<script src="{{ asset('pnkpanel/js/newsletter_list.js') }}"></script>
@endpush
