				...
				<div class="datatables-header-footer-wrapper">
					...
					<div class="datatable-header">
						<div class="row align-items-center mb-3">
							<div class="col-auto mb-3 mb-lg-0"> <a href="{{ route('pnkpanel.customer.edit' ) }}" class="btn btn-primary btn-md"><i class="bx bx-plus"></i> Add New </a> </div>
                        	...
                        	<div class="col-auto mb-3 mb-lg-0"> <a href="{{ route('pnkpanel.customer.export' ) }}" class="btn btn-primary btn-md">Export to CSV</a> </div>
						</div>	
						<div class="row align-items-center mb-3">
							...
							<div class="col-12 col-lg-auto pl-lg-1 text-center">
								<button type="button" class="mb-1 mt-1 mr-1 btn btn-default" onclick="javascript:location.reload(true);"><i class="fas fa-sync"></i> Refresh</button>
							</div>
...
let url_bulk_action = "{{ route('pnkpanel.customer.bulk_action') }}";
let url_email_forgot_password = "{{ route('pnkpanel.customer.email_forgot_password' ) }}";
</script>
<script src="{{ asset('pnkpanel/js/customer_list.js') }}"></script>
@endpush
