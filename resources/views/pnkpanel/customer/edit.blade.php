...
@section('content')
<form action="{{ route('pnkpanel.customer.update') }}" method="post" name="frmCustomer" id="frmCustomer" enctype="multipart/form-data" class="ecommerce-form action-buttons-fixed">
		...
		<div class="col">
			<section class="card">
				...
				<div class="card-body">
						...
						<div class="form-group row">
							<label class="col-lg-3 control-label text-lg-right pt-2" for="password">Password <span class="required">*</span></label>
							<div class="col-lg-6">
						...
						<div class="form-group row">
							<label class="col-lg-3 control-label text-lg-right pt-2" for="confirm_password">Confirm Password <span class="required">*</span></label>
							<div class="col-lg-6">
						...
						<div class="form-group row" id="divstate">
							...
							<div class="col-lg-6">
								<select name="state" id="state" class="form-control form-control-modern @error('state') error @enderror">
									{!! $statecombo !!}
								</select>
								@error('state')
						...
						<div class="form-group row align-items-center">
							<label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0"
								for="site_type">Website Type</label>
							<div class="col-lg-7 col-xl-6">
								<select name="site_type" id="site_type" class="form-control form-control-modern">
									<option value="B2B" {{ old('site_type', $customer->site_type) == 'B2B' ? 'selected' : '' }}>
									B2B</option>
									<option value="B2C" {{ old('site_type', $customer->site_type) == 'B2C' ? 'selected' : '' }}>
									B2C</option>
								</select>
							</div>
						</div>	
...
<script>
let url_list = "{{ route('pnkpanel.customer.list') }}";
let url_edit = "{{ route('pnkpanel.customer.edit', ':id') }}";
let url_update = "{{ route('pnkpanel.customer.update') }}";
let url_delete = "{{ route('pnkpanel.customer.delete', ':id') }}";
</script>
<script src="{{ asset('pnkpanel/js/customer_edit.js') }}"></script>
@endpush
