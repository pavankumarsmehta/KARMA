							...
							<div class="col-12 col-lg-auto ml-auto mb-3 mb-lg-0">
								<div class="d-flex align-items-lg-center flex-column flex-lg-row">
									...
									<select class="form-control select-style-1 search-by" name="search-by">
										...
										<option value="4">State Status ( 0 / 1 )</option>
									</select>
								</div>
							</div>
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0 pl-lg-1">
								<div class="search search-style-1 search-style-1-lg mx-lg-auto">
									<div class="input-group">
										<input type="text" class="search-term form-control" name="search-term" id="search-term" placeholder="Search State">
...
@push('scripts')
<script>
let url_list = "{{ route('pnkpanel.state.list') }}";
let url_bulk_action = "{{ route('pnkpanel.state.bulk_action') }}";
</script>
<script src="{{ asset('pnkpanel/js/state_list.js') }}"></script>
@endpush
