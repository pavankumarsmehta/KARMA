					...
					<table class="table table-ecommerce-simple table-striped mb-0" id="adminGridDataTable" style="min-width: 750px;">
						<thead>
							<tr>
								...
								<th width="16%">Total Orders</th>
								<th width="16%">Sub Total</th>
								<th width="16%">Sales Tax</th>
								<th width="16%">Shipping Charge</th>
								<th width="16%">Order Total Amount</th>
							</tr>
						</thead>
						<tbody>
...
@push('scripts')
<script>
let url_list = "{{ route('pnkpanel.order-report.list') }}";
</script>
<script src="{{ asset('pnkpanel/js/order_report_list.js') }}"></script>
@endpush
