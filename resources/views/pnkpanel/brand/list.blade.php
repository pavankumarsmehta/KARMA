				...
				<div class="datatables-header-footer-wrapper">
					...
					<div class="datatable-header">
						<div class="row align-items-center mb-3">
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0"> <a href="{{ route('pnkpanel.brand.edit' ) }}" class="btn btn-primary btn-md"><i class="bx bx-plus"></i> Add New </a> </div>
...
let url_bulk_action = "{{ route('pnkpanel.brand.bulk_action') }}";
let url_bulk_action_update_rank = "{{ route('pnkpanel.brand.bulk_action_update_rank') }}";
</script>
<script src="{{ asset('pnkpanel/js/brand_list.js') }}"></script>
@endpush
