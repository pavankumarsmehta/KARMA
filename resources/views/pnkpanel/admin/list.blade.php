				...
				<div class="datatables-header-footer-wrapper">
					...
					<div class="datatable-header">
						<div class="row align-items-center mb-3">
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0"> <a href="{{ route('pnkpanel.admin.edit' ) }}" class="btn btn-primary btn-md"><i class="bx bx-plus"></i> Add New </a> </div>
							...
							<div class="col-12 col-lg-auto ml-auto mb-3 mb-lg-0">
								<div class="d-flex align-items-lg-center flex-column flex-lg-row">
									...
									<select class="form-control select-style-1 search-by" name="search-by">
										...
										<option value="2">Admin Type</option>
									</select>
								</div>
							</div>
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0 pl-lg-1">
								<div class="search search-style-1 search-style-1-lg mx-lg-auto">
									<div class="input-group">
										<input type="text" class="search-term form-control" name="search-term" id="search-term" placeholder="Search Admin">
					...
					<table class="table table-ecommerce-simple table-striped mb-0" id="adminGridDataTable" style="min-width: 910px;">
						<thead>
							<tr>
...
let url_bulk_action = "{{ route('pnkpanel.admin.bulk_action') }}";
</script>
<script src="{{ asset('pnkpanel/js/admin_list.js') }}"></script>
@endpush
