...
<form action="{{ route('pnkpanel.order.update') }}" method="post" name="frmOrderDetails" id="frmOrderDetails" class="order-details action-buttons-fixed">
	...
	<input type="hidden" name="is_shipmail" id="is_shipmail" value="{{$order->is_shipmail}}">
	...
	<div class="row action-buttons">
		...
		<div class="col-12 col-md-auto pl-md-0 mt-3 mt-md-0">
			<a class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1 btnSendStatusEmailToClient-js hidden" data-loading-text="Loading..."> <i class="bx bx-mail-send text-4 mr-2"></i> Send Status Email to Client </a>
		</div>
		{{--<div class="col-12 col-md-auto pl-md-0 mt-3 mt-md-0">
