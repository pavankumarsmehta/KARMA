				...
				<div class="datatables-header-footer-wrapper">
					...
					<div class="datatable-header">
						<div class="row align-items-center mb-3">
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0"> <a href="{{ route('pnkpanel.home-page-banner.edit' ) }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4"><i class="bx bx-plus"></i> Add New Banner</a> </div>
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0 pl-lg-1">
								<div class="search search-style-1 search-style-1-lg mx-lg-auto">
									<div class="input-group">
										<input type="text" class="search-term form-control" name="search-term" id="search-term" placeholder="Search Press">
					...
					<table class="table table-ecommerce-simple table-striped mb-0" id="adminGridDataTable" style="min-width: 750px;">
						<thead>
							<tr>
								...
								<th width="15%">Link</th>
								<th width="15%">Display Rank</th>
								<th width="15%">Display Position</th>
								<th width="10%">Status</th>
								<th class="d-none">Home Image</th>
...
let url_bulk_action = "{{ route('pnkpanel.home-page-banner.bulk_action') }}";
let url_bulk_action_update_rank = "{{ route('pnkpanel.home-page-banner.bulk_action_update_rank') }}";
</script>
<script src="{{ asset('pnkpanel/js/home_page_banner_list.js') }}"></script>
@endpush
