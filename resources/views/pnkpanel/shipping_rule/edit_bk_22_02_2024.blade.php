                            ...
                            <select name="shipping_method" id="shipping_method" class="form-control form-control-modern">
                                ...
                                @foreach ($shipping_method as $shipping_method)
                                    ...
                                    <option value="{{ $shipping_method->shipping_mode_id }}"
                                        ...
                                        {{ old('shipping_method', $shipping_rule->shipping_method) == $shipping_method->shipping_mode_id ? 'selected' : '' }}>
	                            ...
	                            <select name="country" id="country" class="form-control form-control-modern"> 
	                                ...
	                                @foreach ($country as $country)
	                                    ...
	                                    <option value="{{ $country->countries_iso_code_2 }}"
	                                        ...
	                                        {{ old('country', $shipping_rule->country) == $country->countries_iso_code_2 ? 'selected' : '' }}>
