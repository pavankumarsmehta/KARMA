...
@section('content')
<form action="{{ route('pnkpanel.product.post_import_limited') }}" method="post" name="frmRepresentative" id="frompostimport"
        ...
        <div class="col">
            <section class="card card-expanded">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Please wait while process the products CSV data</h2>
