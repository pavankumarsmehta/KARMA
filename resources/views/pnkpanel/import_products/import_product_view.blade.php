...
<form action="{{ route('pnkpanel.product.import') }}" enctype="multipart/form-data" method="post" name="frmRepresentative" id="frmRepresentative" class="ecommerce-form action-buttons-fixed">
    ...
    <div class="row">
        <div class="col">
              <section class="card card-expanded">
                <header class="card-header" >
                    <h2 class="card-title float-right mr-5"><a href="{{ route('pnkpanel.product.export') }}" style="text-decoration:underline;">Export Product </a></h2>
                </header>
                        ...
                        <table width="95%" border="0" cellspacing="0" cellpadding="3" align="center">
                            <tbody>
                                <tr class="lightbg">
                                    ...
                                    <?php
                                                    if ($columns[$ii]->Field == 'size') {
                                                        $fieldName = "Attribute 1 Value";
                                                    } elseif ($columns[$ii]->Field == 'pack_size') {
                                                        $fieldName = "Attribute 2 Value";
                                                    } elseif ($columns[$ii]->Field == 'flavour') {
                                                        $fieldName = "Attribute 3 Value";
                                                    } else {
