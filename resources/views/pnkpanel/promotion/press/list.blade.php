				...
				<div class="datatables-header-footer-wrapper">
					...
					<div class="datatable-header">
						<div class="row align-items-center mb-3">
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0"> <a href="{{ route('admin.press.edit' ) }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4"><i class="bx bx-plus"></i> Add New Press</a> </div>
...
let url_bulk_action = "{{ route('admin.press.bulk_action') }}";
let url_bulk_action_update_rank = "{{ route('admin.press.bulk_action_update_rank') }}";
</script>
<script src="{{ asset('admin/js/press_list.js') }}"></script>
@endpush
