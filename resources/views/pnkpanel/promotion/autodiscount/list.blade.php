				...
				<div class="datatables-header-footer-wrapper">
					...
					<div class="datatable-header">
						<div class="row align-items-center mb-3">
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0"> <a href="{{ route('pnkpanel.autodiscount.edit' ) }}" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4"><i class="bx bx-plus"></i> Add New Auto Discount</a> </div>
...
let url_bulk_action = "{{ route('pnkpanel.autodiscount.bulk_action') }}";
</script>
<script src="{{ asset('pnkpanel/js/autodiscount_list.js') }}"></script>
@endpush
