				...
				<div class="datatables-header-footer-wrapper">
					...
					<div class="datatable-header">
						<div class="row align-items-center mb-3">
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0"> <a href="{{ route('pnkpanel.manage-static-page.edit' ) }}" class="btn btn-primary btn-sm"><i class="bx bx-plus"></i> Add New Static Page</a> </div>
							...
							<div class="col-12 col-lg-auto ml-auto mb-3 mb-lg-0">
								<div class="d-flex align-items-lg-center flex-column flex-lg-row">
									...
									<select class="form-control select-style-1 search-by" name="search-by">
                                        ...
                                        <option value="2">Short Name (URL)</option>
									</select>
								</div>
							</div>
							...
							<div class="col-12 col-lg-auto mb-3 mb-lg-0 pl-lg-1">
								<div class="search search-style-1 search-style-1-lg mx-lg-auto">
									<div class="input-group">
										<input type="text" class="search-term form-control" name="search-term" id="search-term" placeholder="Search Static Page">
					...
					<table class="table table-ecommerce-simple table-striped mb-0" id="adminGridDataTable" style="min-width: 750px;">
						<thead>
							<tr>
								...
								<th width="15%">Short Name<br/>(URL)</th>
								<th width="33%">Page URL</th>
...
<script src="{{ asset('pnkpanel/js/static_page_list.js') }}"></script>
@endpush
