...
<div class="container myact">
	...
	<div class="container-650">
		<h1 tabindex="0" class="tac pb-3 hidden-sm-down h2">Register Your Account</h1>
		<h1 tabindex="0" class="tac pb-3 hidden-md-up  h2">Register Your Account</h1>
		...
		<form class="needs-validation" novalidate="" method="post" id="frmRegister">
			...
			<div class="row row10">
				<div class="col-md-6 col-sm-6 pb-2">
					<label for="pass_log_id" class="form-label" >Password <span class="red-color">*</span></label>
					<div class="input-group has-validation">
				...
				<div class="col-md-6 col-sm-6 pb-2">
					<label for="pass_log_id1" class="form-label" >Confirm Password <span class="red-color">*</span></label>
					<div class="input-group has-validation">
			...
			<div class="pb-3 f12" ><strong class="red-color">Note:</strong> Password must contain at least 1 upper case letter (A-Z), 1 number (0-9), min. 8 characters.</div>
			<div class="row row10">
				<div class="col-md-6 col-sm-6 pb-2">
			...
			<div class="pb-2">
				<label for="address" class="form-label" >Street Address <span class="red-color">*</span></label>
			...
			<div class="pb-2">
				<label for="address1" class="form-label" >Street Address 2</label>
