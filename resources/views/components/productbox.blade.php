...
<div class="product clearfix">
  <div class="product_thumb">
    <a href="{{$APP_URLS.$prod['product_url']}}" title="{{$prod['product_name']}}" tabindex="0" aria-label="{{$prod['product_name']}}">
...
">
  ...
  @endif
  <div class="product_name"><a href="{{$APP_URLS.$prod['product_url']}}" title="{{$prod['product_name']}}" tabindex="0">{{$prod['product_name']}}</a></div>
  ...
  @if(isset($prod['current_stock']) && $prod['current_stock'] > 0)
  		@else
		<div class="product-stock outofstock" tabindex="0">Out Of Stock</div>
		@endif
    </div>
</div>
@if(isset($pageType) && !empty($pageType) && $pageType=='Listing')
...
@endif
@if($key==3 && isset($advertisementData) && !empty($advertisementData))
  @if(isset($advertisementData['advertisement_image1']) && !empty($advertisementData['advertisement_image1']) && !empty($advertisementData['advertisement_link1']))             
  <li>
    <div class="product-banner">
      <a href="{{$advertisementData['advertisement_link1']}}" title="{{$advertisementData['advertisement_title1']}}" class="pro-banner" tabindex="0">
        <picture>
            <source media="(min-width:768px)" srcset="{{$advertisementData['advertisement_image1']}}">
            <img src="{{$advertisementData['advertisement_image1']}}" alt="" width="365" height="500" loading="lazy" /> 
          </picture>
      </a>
    </div>
  </li>
  @endif
@endif
@if($key==9 && isset($advertisementData) && !empty($advertisementData))
  @if(isset($advertisementData['advertisement_image2']) && !empty($advertisementData['advertisement_image2']) && !empty($advertisementData['advertisement_link2']))             
  <li class="list-pro-banner">
    <div class="product">
      <a href="{{$advertisementData['advertisement_link2']}}" title="{{$advertisementData['advertisement_title2']}}" class="pro-banner" tabindex="0">
        <picture>
            <source media="(min-width:768px)" srcset="{{$advertisementData['advertisement_image2']}}">
            <img src="{{$advertisementData['advertisement_image2']}}" alt="" width="365" height="500" loading="lazy" /> 
          </picture>
      </a>
    </div>   
  </li>
