				...
				<div class="popularbrands clearfix">
					<div class="cm-hd">
						<div class="cm-hd-left">
							...
							<a href="{{config('const.SITE_URL')}}/brand-all.html" class="linksbb hidden-sm-down1" title="View all popular brands" tabindex="0"><strong>View all popular brands</strong></a>
						</div>
					</div>
				@endslot
				@slot('product_start_section')
...
<section class="space70 homabo-man clearfix" aria-label="Reviews from our community">
	<div class="container-pd">
		<div class="container">
			<div class="homabo ">
				<div id="haboutus"></div>
...
@if(isset($HomePage_instagram) && count($HomePage_instagram) > 0)
<section class="space70" aria-label="{{config('const.SITE_NAME')}} on Instagram">
	<div class="container-pd">
		<div class="container">
			<div class="instagram-slider clearfix">
				<div class="cm-hd">
					...
					<div class="cm-hd-right"><a href="https://www.instagram.com/hbastore1/" target="_blank" class="linksbb" tabindex="0" title="Get Inspired" aria-label="Get Inspired"><strong>Get Inspired</strong></a></div>
				</div>
				<div class="instagramowl slick-space-20 slickarrow-ovr no-loaded">
					@foreach ($HomePage_instagram as $instagram)
					<a href="{{$instagram['permalink']}}" target="_blank" title="{{$instagram['permalink']}}">
						<picture><img src="{{$instagram['media_url']}}" alt="{{$instagram['permalink']}}" width="365" height="365" loading="lazy" /></picture>
					</a>
					@endforeach
				</div>
			</div>
