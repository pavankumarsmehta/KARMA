...
class CustomerController extends Controller
{
	...
	public function OrderHistory(Request $request)
	{
		...
		//dd($allorder);
		if (Auth::user()) {
			$OrdResultQuery = Order::select('order_id', 'sub_total', 'order_total', 'pay_status', 'tracking_no', 'ShippingCompany' ,'status', DB::raw("DATE_FORMAT(order_datetime, '%m/%d/%Y %H:%i') AS datetime"))
				->where('customer_id', '=', Session::get('customer_id'));
		}
