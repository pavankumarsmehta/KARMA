	...
	private function sendMailToCustomer($order_id, Request $request)
	{
		...
		if ($tracking_no == "") {
			...
			if ($ship_method == 'FedEx') {
				...
				$str_ship .= '<strong>Shipping Via : </strong>' . $ship_method . '<br>';
				$str_ship .= "<strong>Tracking Number :</strong> <a href=\"" . $Site_URL . "index.php?file=tracking_single&trackingno=" . $tracking_no . "\" target=\"_blank\">" . $tracking_no . "</a>";
			} elseif ($ship_method == 'Text') {
				$str_ship .= '<strong>Shipping Via : </strong>' . $ship_method . '<br>';
				$str_ship .= "<strong>Tracking Number :</strong> " . $tracking_no;
			} else if ($ship_method == 'Express Global') {
				$str_ship .= '<strong>Shipping Via : </strong>' . $ship_method . '<br>';
				$str_ship .= "<strong>Tracking Number :</strong> <a href=\"http://www.xgsi.com/common/xpresstrace.aspx?numbers=" . $tracking_no . "\" target=\"_blank\">" . $tracking_no . "</a>";
			} else if ($ship_method == 'Southeastern') {
				$str_ship .= '<strong>Shipping Via : </strong>' . $ship_method . '<br>';
				$str_ship .= "<strong>Tracking Number :</strong> <a href=\"https://www.sefl.com/seflWebsite/shipping/Tracing.jsp?RefNum=" . $tracking_no . "\" target=\"_blank\">" . $tracking_no . "</a>";
			} else if ($ship_method == 'Averitt') {
				$str_ship .= '<strong>Shipping Via : </strong>' . $ship_method . '<br>';
				$str_ship .= "<strong>Tracking Number :</strong> <a href=\"https://www.averittexpress.com/tracking/ltl/by-id\" target=\"_blank\">" . $tracking_no . "</a>";
			} elseif ($ship_method == 'Manufacturer') {
				$str_ship .= '<strong>Shipping Via : </strong>' . $ship_method . '<br>';
				$str_ship .= "<strong>Tracking Number :</strong> " . $tracking_no;
			}
		}
